...
import bondedCoinMetadataData from "./legacy/data/bonded_out_metadata.json" assert { type: "json" };
...
export const BondedOutCoinMetadata = bondedCoinMetadataData as Record<string, CoinMetadata>;